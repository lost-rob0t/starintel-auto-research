---
name: "api-design"
description: "Design versioned, authorized, rate-limited public APIs."
version: "1.0.0"
author: "lost-rob0t"
category: "product"
tags: ["starintel", "product", "api-design"]
---
...
Design versioned, authorized, rate-limited public APIs.
...
3. Apply the `api-design` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
