...
description: "Review dependency source, license, security, and reproducibility."
version: "1.0.0"
author: "lost-rob0t"
category: "security"
tags: ["starintel", "security", "dependency-review"]
---
...
Review dependency source, license, security, and reproducibility.
...
3. Apply the `dependency-review` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
