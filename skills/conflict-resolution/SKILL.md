...
description: "Resolve conflicts while preserving intent and history."
version: "1.0.0"
author: "lost-rob0t"
category: "git"
tags: ["starintel", "git", "conflict-resolution"]
---
...
Resolve conflicts while preserving intent and history.
...
3. Apply the `conflict-resolution` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
