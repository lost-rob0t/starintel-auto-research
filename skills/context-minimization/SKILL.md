...
description: "Keep agent context bounded and source-linked."
version: "1.0.0"
author: "lost-rob0t"
category: "agents"
tags: ["starintel", "agents", "context-minimization"]
---
...
Keep agent context bounded and source-linked.
...
3. Apply the `context-minimization` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
