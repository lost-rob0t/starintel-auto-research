...
description: "Ingest HTML, PDF, email, chat, text, and transcripts."
version: "1.0.0"
author: "lost-rob0t"
category: "documents"
tags: ["starintel", "documents", "unstructured-ingest"]
---
...
Ingest HTML, PDF, email, chat, text, and transcripts.
...
3. Apply the `unstructured-ingest` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
