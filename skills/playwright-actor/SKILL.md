...
description: "Build an isolated browser actor for dynamic sources."
version: "1.0.0"
author: "lost-rob0t"
category: "collection"
tags: ["starintel", "collection", "playwright-actor"]
---
...
Build an isolated browser actor for dynamic sources.
...
3. Apply the `playwright-actor` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
