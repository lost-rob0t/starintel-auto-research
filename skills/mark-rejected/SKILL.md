...
3. Use `scripts/mark-design.py rejected`; when multiple projects have active designs, pass `--project <project>`. Require a reason and evidence, preserve the canonical file, then run `scripts/sync.py`.
