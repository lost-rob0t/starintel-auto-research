...
description: "Measure speedups against a controlled baseline."
version: "1.0.0"
author: "lost-rob0t"
category: "quality"
tags: ["starintel", "quality", "performance-benchmark"]
---
...
Measure speedups against a controlled baseline.
...
3. Apply the `performance-benchmark` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
