---
name: "pricing-model"
description: "Model hosted pricing below equivalent API stacking."
version: "1.0.0"
author: "lost-rob0t"
category: "product"
tags: ["starintel", "product", "pricing-model"]
---
...
Model hosted pricing below equivalent API stacking.
...
3. Apply the `pricing-model` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
