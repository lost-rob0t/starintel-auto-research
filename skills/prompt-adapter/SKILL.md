---
name: "prompt-adapter"
description: "Map AGENTS.md into a native agent-system adapter."
version: "1.0.0"
author: "lost-rob0t"
category: "skills"
tags: ["starintel", "skills", "prompt-adapter"]
---
...
Map AGENTS.md into a native agent-system adapter.
...
3. Apply the `prompt-adapter` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
