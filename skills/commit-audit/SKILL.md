---
name: "commit-audit"
description: "Review only commits after a known audited baseline."
version: "1.0.0"
author: "lost-rob0t"
category: "git"
tags: ["starintel", "git", "commit-audit"]
---
...
Review only commits after a known audited baseline.
...
3. Apply the `commit-audit` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
