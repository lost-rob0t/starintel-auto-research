---
name: "fulltext-index"
description: "Design cross-dataset full-text indexing and ranking."
version: "1.0.0"
author: "lost-rob0t"
category: "search"
tags: ["starintel", "search", "fulltext-index"]
---
...
Design cross-dataset full-text indexing and ranking.
...
3. Apply the `fulltext-index` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
