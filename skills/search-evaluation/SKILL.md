...
description: "Evaluate ranking against fixed relevance cases."
version: "1.0.0"
author: "lost-rob0t"
category: "search"
tags: ["starintel", "search", "search-evaluation"]
---
...
Evaluate ranking against fixed relevance cases.
...
3. Apply the `search-evaluation` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
