...
description: "Prevent duplicate message effects."
version: "1.0.0"
author: "lost-rob0t"
category: "routing"
tags: ["starintel", "routing", "message-idempotency"]
---
...
Prevent duplicate message effects.
...
3. Apply the `message-idempotency` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
