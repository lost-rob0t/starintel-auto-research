...
description: "Separate evidence, user decisions, and inference."
version: "1.0.0"
author: "lost-rob0t"
category: "research"
tags: ["starintel", "research", "research-synthesis"]
---
...
Separate evidence, user decisions, and inference.
...
3. Apply the `research-synthesis` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
