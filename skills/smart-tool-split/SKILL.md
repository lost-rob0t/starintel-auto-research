---
name: "smart-tool-split"
description: "Separate reasoning and writing from tool invocation."
version: "1.0.0"
author: "lost-rob0t"
category: "agents"
tags: ["starintel", "agents", "smart-tool-split"]
---
...
Separate reasoning and writing from tool invocation.
...
3. Apply the `smart-tool-split` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
