---
name: "authorization"
description: "Design default-deny dataset and document authorization."
version: "1.0.0"
author: "lost-rob0t"
category: "security"
tags: ["starintel", "security", "authorization"]
---
...
Design default-deny dataset and document authorization.
...
3. Apply the `authorization` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
