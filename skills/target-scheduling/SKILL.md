...
description: "Persist and recover recurring target schedules."
version: "1.0.0"
author: "lost-rob0t"
category: "actors"
tags: ["starintel", "actors", "target-scheduling"]
---
...
Persist and recover recurring target schedules.
...
3. Apply the `target-scheduling` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
