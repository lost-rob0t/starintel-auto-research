---
name: "handoff-active-design"
description: "Hand off active implementation state without hidden assumptions."
version: "1.0.0"
author: "lost-rob0t"
category: "workflow"
tags: ["starintel", "workflow", "handoff-active-design"]
---

# Handoff Active Design

## Objective

Hand off active implementation state without hidden assumptions.
...
3. Apply the `handoff-active-design` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
