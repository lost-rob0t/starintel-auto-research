---
name: "scraper-harness"
description: "Test scraper extraction, pagination, and provenance."
version: "1.0.0"
author: "lost-rob0t"
category: "collection"
tags: ["starintel", "collection", "scraper-harness"]
---
...
Test scraper extraction, pagination, and provenance.
...
3. Apply the `scraper-harness` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
