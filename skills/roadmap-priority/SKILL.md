...
description: "Order work by dependency, leverage, risk, and mission value."
version: "1.0.0"
author: "lost-rob0t"
category: "product"
tags: ["starintel", "product", "roadmap-priority"]
---
...
Order work by dependency, leverage, risk, and mission value.
...
3. Apply the `roadmap-priority` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
