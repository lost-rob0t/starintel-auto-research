...
description: "Validate migrations, artifacts, rollback, and release evidence."
version: "1.0.0"
author: "lost-rob0t"
category: "quality"
tags: ["starintel", "quality", "release-checklist"]
---
...
Validate migrations, artifacts, rollback, and release evidence.
...
3. Apply the `release-checklist` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
