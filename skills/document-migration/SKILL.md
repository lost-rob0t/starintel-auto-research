...
description: "Migrate stored documents between schema versions."
version: "1.0.0"
author: "lost-rob0t"
category: "documents"
tags: ["starintel", "documents", "document-migration"]
---
...
Migrate stored documents between schema versions.
...
3. Apply the `document-migration` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
