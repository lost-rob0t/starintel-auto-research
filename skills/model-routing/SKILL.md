---
name: "model-routing"
description: "Route reasoning and tool tasks to suitable models."
version: "1.0.0"
author: "lost-rob0t"
category: "agents"
tags: ["starintel", "agents", "model-routing"]
---
...
Route reasoning and tool tasks to suitable models.
...
3. Apply the `model-routing` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
