...
description: "Coordinate schema and protocol changes across repositories."
version: "1.0.0"
author: "lost-rob0t"
category: "git"
tags: ["starintel", "git", "cross-repo-change"]
---
...
Coordinate schema and protocol changes across repositories.
...
3. Apply the `cross-repo-change` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
