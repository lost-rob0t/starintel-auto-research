---
name: "lmdb-design"
description: "Model LMDB keys, transactions, indexes, and recovery."
version: "1.0.0"
author: "lost-rob0t"
category: "storage"
tags: ["starintel", "storage", "lmdb-design"]
---
...
Model LMDB keys, transactions, indexes, and recovery.
...
3. Apply the `lmdb-design` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
