...
description: "Create a narrow reusable SKILL.md procedure."
version: "1.0.0"
author: "lost-rob0t"
category: "skills"
tags: ["starintel", "skills", "skill-authoring"]
---
...
Create a narrow reusable SKILL.md procedure.
...
3. Apply the `skill-authoring` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
