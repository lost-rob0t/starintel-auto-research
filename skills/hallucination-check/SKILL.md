...
description: "Remove unsupported APIs, facts, and test claims."
version: "1.0.0"
author: "lost-rob0t"
category: "agents"
tags: ["starintel", "agents", "hallucination-check"]
---
...
Remove unsupported APIs, facts, and test claims.
...
3. Apply the `hallucination-check` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
