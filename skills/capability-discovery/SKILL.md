...
description: "Discover actor capabilities and protocol versions."
version: "1.0.0"
author: "lost-rob0t"
category: "routing"
tags: ["starintel", "routing", "capability-discovery"]
---
...
Discover actor capabilities and protocol versions.
...
3. Apply the `capability-discovery` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
