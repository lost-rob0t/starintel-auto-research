...
description: "Benchmark persistence throughput, latency, and recovery."
version: "1.0.0"
author: "lost-rob0t"
category: "storage"
tags: ["starintel", "storage", "storage-benchmark"]
---
...
Benchmark persistence throughput, latency, and recovery.
...
3. Apply the `storage-benchmark` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
