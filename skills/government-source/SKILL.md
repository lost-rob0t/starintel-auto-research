...
description: "Research and integrate an official government source."
version: "1.0.0"
author: "lost-rob0t"
category: "collection"
tags: ["starintel", "collection", "government-source"]
---
...
Research and integrate an official government source.
...
3. Apply the `government-source` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
