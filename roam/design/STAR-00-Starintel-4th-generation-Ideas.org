...
**** TODO Optional scope module
***** Program scope ingestion
***** Optional domain and CIDR filters
***** Optional target filtering
***** Optional per-tool policy
***** Optional request-rate policy
...
***** Record configured accounts
***** Record configured guilds and channels
***** Optional collection-boundary policy
***** Optional Discord rate policy
***** Optional access-expiration handling
***** Preserve Discord-supplied data packages
***** Support optional execution logs
***** Optional collection shutdown on access expiration
...
**** TODO Optional access module
***** Session ownership records
***** Configured chat identifiers
***** Optional public/private source classification
***** Optional per-chat collection policy
...
Use for source collection, organization sites, platform projects, or sites selected by the operator.
...
***** Optional depth policy
***** Optional request budgets
***** Optional rate policy
***** Optional robots and source-policy metadata
***** Optional authentication isolation
***** Duplicate-request detection
***** Content hashing
***** Spider versioning
***** Replayable fixtures
***** Optional shutdown on configured boundary violation
...
**** TODO Optional deployment modules
***** Optional target-domain filtering
***** Optional action policy
***** Optional credential isolation
***** Optional download quarantine
***** Optional popup and navigation controls
***** Request interception
***** Optional execution timeouts
***** Optional browser resource limits
***** Optional interaction logs
***** Deterministic replay where possible

*** k. Proxy-Rotation Actor

Manage proxies supplied by the operator, customer, platform, or collection provider.
...
**** TODO Optional deployment restrictions
***** Bind every proxy to an assigned operation
***** Optional actor-to-proxy assignment journal
***** Optional provider-limit policy
***** Optional proxy expiration policy
...
**** TODO Optional access module
***** Optional instance-policy metadata
***** Record API credentials and scopes
***** Optional per-instance rate policy
***** Track access expiration
***** Support optional instance-specific retention rules
...
**** TODO Optional deployment modules
***** Optional service and repository scope policy
...
Support source collection and platform collection from 4chan, 8kun.top, and compatible imageboard software.
...
***** Optional collection-rate policy
***** Source timestamps
...
***** Optional subreddit filters
***** Support moderator access
***** Optional Reddit rate policy
***** Optional collection shutdown on access revocation
...
***** Record account acquisition context
***** Record configured organizations
***** Optional API-scope policy
***** Optional retention policy
***** Optional access-expiration handling
***** Preserve source exports unchanged
***** Apply optional profile and relationship filters
...
***** Attachment handling
***** Optional authentication isolation
***** Optional credential revocation
***** Optional health checks
***** Mock transports
***** Replay transports
...
**** TODO Sensitivity
**** TODO Classification
**** TODO Optional access-control labels
**** TODO Optional retention policy
**** TODO Optional expiration policy
**** TODO Optional deletion policy
**** TODO Optional legal hold
**** TODO Optional chain of custody
**** TODO Provenance
...
**** TODO Optional review state
**** TODO Error records
**** TODO Warning records
**** TODO Human edits
**** TODO Optional review decisions
...
**** TODO Optional redacted variants
**** TODO Distribution variants
**** TODO Parsing errors
...
**** TODO Optional sandboxed execution
**** TODO Optional capability-based permissions
**** TODO Optional read-only mode
**** TODO Optional network restriction
**** TODO Optional filesystem restriction
**** TODO Optional process-execution restriction
**** TODO Optional secret-access restriction
**** TODO Optional CPU limits
**** TODO Optional memory limits
**** TODO Optional execution-time limits
**** TODO Optional output-size limits
**** TODO Optional dependency policy
**** TODO Dependency lockfiles
**** TODO Optional signed view packages
**** TODO Versioned view packages
**** TODO Optional static analysis before installation
**** TODO Optional Content Security Policy
**** TODO Optional HTML sanitization
**** TODO Optional output escaping
**** TODO Optional per-view field filters
**** TODO Optional per-view dataset filters
**** TODO Support optional execution logging
**** TODO Optional installation policy
**** TODO Optional emergency disable controls
**** TODO Optional fallback renderer
...
**** TODO Optional malware scanning
**** TODO Optional quarantine
**** TODO Optional encryption at rest
**** TODO Optional per-file access control
**** TODO Optional retention policy
**** TODO Optional deletion policy
**** TODO Optional legal holds
**** TODO Optional evidence-preservation flags
**** TODO Optional chain-of-custody records
**** TODO External object-storage references
**** TODO Multipart uploads
**** TODO Resumable uploads
**** TODO Optional download limits
**** TODO Optional bandwidth limits
...
**** TODO Optional analyst confirmation
**** TODO Fact correction
**** TODO Optional query budgets
**** TODO Optional recursion limits
**** TODO Optional inference-time limits
**** TODO Optional sandboxed custom predicates
...
**** TODO Fingerprint activity history
...
**** TODO Preserve government identifiers
...
**** TODO Optional analyst review state
...
**** TODO Optional execution history
...
**** TODO Optional graph traversal limits
...
**** TODO Optional permission-aware indexing
...
**** TODO Optional analyst queues
**** TODO Quality scoring
**** TODO Repair suggestions
**** TODO Optionally quarantine invalid documents without deleting them
...
**** TODO Optional redacted exports
...
**** TODO Optional case-specific access controls
**** TODO Notes
**** TODO Tasks
**** TODO Hypotheses
**** TODO Optional review states
**** TODO Evidence numbering
**** TODO Optional chain of custody
**** TODO Exportable case bundles
**** TODO Case templates
**** TODO Cross-case linking
**** TODO Optional case-isolation policy
...
**** TODO Convert selected annotations into facts
**** TODO Convert selected annotations into training data
...
***** TODO Timeouts
***** TODO Cancellation
***** TODO Optional dead-letter handling
