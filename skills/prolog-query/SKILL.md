---
name: "prolog-query"
description: "Run provenance-aware graph and rule queries."
version: "1.0.0"
author: "lost-rob0t"
category: "search"
tags: ["starintel", "search", "prolog-query"]
---
...
Run provenance-aware graph and rule queries.
...
3. Apply the `prolog-query` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
