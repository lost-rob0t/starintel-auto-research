...
description: "Check work against the dangerous-search-engine mission."
version: "1.0.0"
author: "lost-rob0t"
category: "product"
tags: ["starintel", "product", "mission-alignment"]
---
...
Check work against the dangerous-search-engine mission.
...
3. Apply the `mission-alignment` procedure to the active design, preserve project boundaries and provenance, and make the strongest validated change consistent with the user's direction.
