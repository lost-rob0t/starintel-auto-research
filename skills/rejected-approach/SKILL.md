---
name: "rejected-approach"
description: "Record why an approach was rejected and when to reconsider."
version: "1.0.0"
author: "lost-rob0t"
category: "design"
tags: ["starintel", "design", "rejected-approach"]
---
...
Record why an approach was rejected and when to reconsider.
...
3. Apply the `rejected-approach` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
