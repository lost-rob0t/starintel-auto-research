---
name: "event-replay"
description: "Rebuild derived state deterministically from events."
version: "1.0.0"
author: "lost-rob0t"
category: "storage"
tags: ["starintel", "storage", "event-replay"]
---
...
3. Apply the `event-replay` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
