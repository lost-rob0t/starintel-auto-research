...
description: "Test real actor, queue, database, and API boundaries."
version: "1.0.0"
author: "lost-rob0t"
category: "quality"
tags: ["starintel", "quality", "integration-tests"]
---
...
Test real actor, queue, database, and API boundaries.
...
3. Apply the `integration-tests` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
