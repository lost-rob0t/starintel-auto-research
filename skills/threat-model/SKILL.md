---
name: "threat-model"
description: "Model assets, trust boundaries, abuse cases, and mitigations."
version: "1.0.0"
author: "lost-rob0t"
category: "security"
tags: ["starintel", "security", "threat-model"]
---
...
Model assets, trust boundaries, abuse cases, and mitigations.
...
3. Apply the `threat-model` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
