---
name: "agent-zero-subagents"
description: "Delegate bounded Agent Zero subordinate work."
version: "1.0.0"
author: "lost-rob0t"
category: "agents"
tags: ["starintel", "agents", "agent-zero-subagents"]
---

# Agent Zero Subagents

## Objective

Delegate bounded Agent Zero subordinate work.
...
3. Apply the `agent-zero-subagents` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
