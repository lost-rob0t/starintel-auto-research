...
- Preserve every `#+status:` value and every research body byte-for-byte. Canonical approval fields must remain immediately after lifecycle metadata, use `adard.research-approval.v1`, and keep lifecycle and approval as independent dimensions.
