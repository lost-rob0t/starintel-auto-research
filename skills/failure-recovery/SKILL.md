...
description: "Recover agent workflows without repeating failed actions."
version: "1.0.0"
author: "lost-rob0t"
category: "agents"
tags: ["starintel", "agents", "failure-recovery"]
---
...
Recover agent workflows without repeating failed actions.
...
3. Apply the `failure-recovery` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
