...
description: "Keep credentials out of code, logs, and artifacts."
version: "1.0.0"
author: "lost-rob0t"
category: "security"
tags: ["starintel", "security", "secret-handling"]
---
...
Keep credentials out of code, logs, and artifacts.
...
3. Apply the `secret-handling` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
