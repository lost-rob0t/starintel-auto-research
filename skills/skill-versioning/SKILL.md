...
description: "Version skill behavior and migration notes."
version: "1.0.0"
author: "lost-rob0t"
category: "skills"
tags: ["starintel", "skills", "skill-versioning"]
---
...
Version skill behavior and migration notes.
...
3. Apply the `skill-versioning` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
