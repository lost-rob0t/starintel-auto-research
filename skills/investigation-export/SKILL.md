...
description: "Export portable investigations with evidence and hashes."
version: "1.0.0"
author: "lost-rob0t"
category: "product"
tags: ["starintel", "product", "investigation-export"]
---
...
Export portable investigations with evidence and hashes.
...
3. Apply the `investigation-export` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
