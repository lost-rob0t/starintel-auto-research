...
description: "Reject traversal, injection, invalid, and oversized input."
version: "1.0.0"
author: "lost-rob0t"
category: "security"
tags: ["starintel", "security", "input-validation"]
---
...
Reject traversal, injection, invalid, and oversized input.
...
3. Apply the `input-validation` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
