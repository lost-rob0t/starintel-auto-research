---
name: "test-first"
description: "Reproduce bugs and add regression tests before fixing."
version: "1.0.0"
author: "lost-rob0t"
category: "quality"
tags: ["starintel", "quality", "test-first"]
---
...
Reproduce bugs and add regression tests before fixing.
...
3. Apply the `test-first` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
