---
name: "star-actor-cache"
description: "Design the Nim and LMDB cache/database layer."
version: "1.0.0"
author: "lost-rob0t"
category: "storage"
tags: ["starintel", "storage", "star-actor-cache"]
---
...
Design the Nim and LMDB cache/database layer.
...
3. Apply the `star-actor-cache` procedure to the active design, preserve project boundaries and provenance, and make the smallest validated change.
